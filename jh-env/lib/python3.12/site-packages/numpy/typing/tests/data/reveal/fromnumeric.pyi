...
assert_type(np.repeat(b), npt.NDArray[np.bool])
assert_type(np.repeat(f4), npt.NDArray[np.float32])
assert_type(np.repeat(f), npt.NDArray[Any])
assert_type(np.repeat(AR_b), npt.NDArray[np.bool])
assert_type(np.repeat(AR_f4), npt.NDArray[np.float32])
